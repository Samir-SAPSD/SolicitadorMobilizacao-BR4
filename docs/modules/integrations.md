...
A autenticação com o SharePoint é gerenciada pelos scripts PowerShell via **PnP PowerShell** com certificado digital. Os detalhes de configuração estão documentados em `backend/docs/README-PnP-Certificado.md`.
